...
public class HomeController : Controller
{
    ...
    {
        // ViewBag.Message = _privacyDataService.GetPrivacyDataAsync().Result; //.Result blocks the thread while waiting for operation to complete. which can lead to deadlocks and performance issues
